...
// exporting usersData array (named export)
export const myName="Priyanshu Yadav";
// you can change the name "myName" while exporting if you want to use a different name in another file
